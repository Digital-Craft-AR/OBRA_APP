...
You are the **epic coordinator** for this repository. **Do not** produce a long “prompt to copy” for the user. 
...
- Repository: **`Digital-Craft-AR` / `OBRA_APP`** (use github CLI with this `owner` and `repo`).
