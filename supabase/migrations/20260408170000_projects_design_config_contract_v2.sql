-- design_config contract v2 (mode + presetId). Plain SQL only: no PL/pgSQL SET DEFAULT
-- (Postgres rejects variables/column-like identifiers in DEFAULT for ALTER in DO blocks).

update public.projects
set design_config = $dc$
{
  "mode": "preset",
  "presetId": "oceanic",
