...
**Implementación:** `supabase/functions/_shared/prompts.ts` → función `generateBumpTitlesPrompt()`  
...
_Estos ejemplos son los casos de test canónicos para `generateBumpTitlesPrompt()` en `_shared/prompts.ts`._
