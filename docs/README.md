...
**Onboarding:** There is no root `ONBOARDING.md` in this repo yet. For **Supabase** region, project ref, and **environment variable names** (local + Vercel), start with [infrastructure/supabase.md](infrastructure/supabase.md).
