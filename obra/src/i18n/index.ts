...
const resources = {
  es: {
    translation: {
      ...
      "wizard.structure.packageLocked.hint":
        "Ya generamos los entregables en la base de datos. Para sumar o quitar bonuses u order bumps, usá “Modificar cantidad”.",
      "wizard.structure.packageModify.openButton": "Modificar cantidad",
      "wizard.structure.packageModify.title": "Modificar cantidad del paquete",
      "wizard.structure.packageModify.subtitle":
        "Podés agregar slots hasta el máximo permitido o quitar filas existentes. Quitar un bonus u order bump elimina su contenido asociado en la base de datos.",
      ...
      "wizard.structure.packageModify.closeAria": "Cerrar modal de cantidad del paquete",
  ...
  "pt-BR": {
    translation: {
      ...
      "wizard.structure.step3.bumpHint": "Máximo 2",
      "wizard.structure.packageLocked.hint":
        "Já geramos os entregáveis no banco de dados. Para adicionar ou remover bônus ou order bumps, use “Modificar quantidade”.",
      "wizard.structure.packageModify.openButton": "Modificar quantidade",
      "wizard.structure.packageModify.title": "Modificar quantidade do pacote",
      "wizard.structure.packageModify.subtitle":
        "Você pode adicionar slots até o máximo permitido ou remover linhas existentes. Remover um bônus ou order bump apaga o conteúdo associado no banco de dados.",
      ...
      "wizard.structure.packageModify.closeAria": "Fechar modal de quantidade do pacote",
