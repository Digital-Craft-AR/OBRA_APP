...
const resources = {
  es: {
    translation: {
      ...
      "settings.credits.topUpSoon": "El checkout de recarga se habilitará cuando el flujo de Mercado Pago esté conectado.",
  ...
  "pt-BR": {
    translation: {
      ...
      "settings.credits.topUpSoon": "O checkout de recarga será habilitado quando o fluxo do Mercado Pago estiver conectado.",
