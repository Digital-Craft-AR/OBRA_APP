...
const resources = {
  es: {
    translation: {
      ...
      "settings.billing.cancelModal.credits": "Créditos sin usar: {{count}}",
      "settings.billing.cancelModal.activeProjects": "Proyectos activos: {{count}}",
      "settings.billing.cancelModal.accessUntil": "Seguís teniendo acceso hasta {{date}}",
