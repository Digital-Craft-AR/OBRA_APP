...
const resources = {
  es: {
    translation: {
      ...
      "mobile.title": "Obra está hecha para pantallas grandes.",
      "mobile.body": "Abrila desde tu computadora para crear tu próximo infoproducto.",
      ...
      "projects.duplicate.menuLabel": "Duplicar",
      "projects.duplicate.title": "¿Duplicar proyecto?",
      "projects.duplicate.body": "Se creará una copia completa del proyecto. El duplicado comenzará en el paso de Contenido.",
      "projects.duplicate.confirm": "Duplicar",
      "projects.duplicate.cancel": "Cancelar",
      "projects.duplicate.loading": "Duplicando…",
      "projects.duplicate.error": "No se pudo duplicar el proyecto.",
      "projects.duplicate.limitError": "Ya tenés 20 proyectos activos. Archivá o eliminá alguno antes de duplicar.",
      ...
      "wizard.preview.export.generatePdf": "Generar PDF",
      "wizard.preview.export.regeneratePdf": "Re-generar PDF",
      "wizard.preview.export.download": "Descargar PDF",
      ...
      "wizard.preview.exportPdf.title": "Exportar PDF",
      "wizard.preview.exportPdf.closeLabel": "Cerrar exportación de PDF",
      "wizard.preview.exportPdf.generating": "Generando tu PDF…",
      "wizard.preview.exportPdf.timeRemaining": "Aproximadamente {{seconds}}s restantes",
      "wizard.preview.exportPdf.almostDone": "¡Ya casi está…",
      "wizard.preview.exportPdf.ready": "¡PDF listo!",
      "wizard.preview.exportPdf.readySubtitle": "Tu PDF está listo para descargar",
      "wizard.preview.exportPdf.failed": "Error al generar",
      "wizard.preview.exportPdf.downloadCta": "Descargar",
      "wizard.preview.exportPdf.tryAgainCta": "Volver a intentar",
      "wizard.preview.exportPdf.closeCta": "Cerrar",
      "wizard.preview.exportPdf.noUrlError": "El PDF se generó pero el link de descarga no está disponible. Exportá de nuevo.",
      "wizard.preview.exportPdf.genericError": "Error al generar el PDF.",
      ...
      "wizard.preview.shell.generating": "Generando vista previa",
      "wizard.preview.shell.generatingTitle": "Diseñando tu ebook…",
      "wizard.preview.shell.generatingHint": "La IA está armando el diseño editorial completo. Puede tardar un par de minutos.",
      "wizard.preview.shell.loadingMsgs": [
        "Aplicando tu paleta de colores y tipografía…",
        "Esto puede tardar. Aprovechá para tomar un café.",
        "Generando las páginas una por una…",
        "La IA está trabajando en tu diseño editorial…",
        "Ya casi está, aguantá un segundo…",
      ...
      "wizard.preview.shell.regenerateCta": "Regenerar diseño",
      ...
      "wizard.preview.generateModal.styleTitle": "Estilo visual",
      "wizard.preview.generateModal.style.illustration": "Ilustraciones",
      "wizard.preview.generateModal.style.photography": "Fotografía",
      "wizard.preview.generateModal.style.isometric": "Isométrico",
      "wizard.preview.generateModal.style.minimalist": "Minimalista",
      "wizard.preview.generateModal.style.watercolor": "Acuarela",
      ...
      "wizard.create.source.ai.cardDescription":
        "La IA redacta la tabla de contenido y todo el contenido de tu ebook basándose en tu tema, avatar y estructura.",
      "wizard.create.source.ai.bullet1": "Tabla de contenido generada y editable antes de escribir",
      ...
      "wizard.create.source.ai.description":
        "La fase de Contenido genera tabla de contenido y capítulos usando IA.",
      ...
      "wizard.create.source.upload.bullet2": "Análisis automático de estructura y tabla de contenido",
      ...
      "wizard.structure.design.bookTemplate.classic_fixed.description":
        "Portada, tabla de contenido, apertura de capítulo y cuerpo con un layout estable y predecible.",
      ...
      "wizard.structure.avatarReset.modal.step2Body":
        "Esto reinicia los hitos de contenido del proyecto (tablas de contenido, capítulos y progreso), mantiene Estructura completada y te devuelve a Contenido paso 2 con los nuevos parámetros.",
      ...
      "wizard.content.planReview.title": "Revisá tu plan",
      "wizard.content.planReview.subtitle": "Revisá y editá las tablas de contenido de cada producto antes de confirmar.",
      "wizard.content.planReview.confirm": "Confirmar tablas de contenido",
      "wizard.content.planReview.chapterCount_one": "{{count}} capítulo",
      "wizard.content.planReview.chapterCount_other": "{{count}} capítulos",
      "wizard.content.planReview.chapterCount": "{{count}} capítulos",
      "wizard.content.generating.approveArtifact": "Aprobar y continuar",
      "wizard.content.generating.approveArtifactLoading": "Aprobando…",
      "wizard.content.generating.artifactApproved": "¡Artefacto aprobado!",
      "wizard.content.generating.generateAll": "Generar todos con IA",
      "wizard.content.generating.stopGenerate": "Detener generación",
      "wizard.content.generating.allDone": "¡Paquete completo! Ya podés ir a Vista previa.",
      "wizard.content.generating.backWarningTitle": "¿Volvés a editar el plan?",
      "wizard.content.generating.backWarningBody": "Podés editar los capítulos, pero se va a reabrir la tabla de contenido y necesitarás confirmar el plan de nuevo.",
      "wizard.content.generating.backWarningConfirm": "Sí, reabrir tabla de contenido",
      "wizard.content.generating.backWarningCancel": "Seguir editando",
      ...
      "wizard.content.inner.toc": "Tabla de contenido",
      "wizard.content.inner.manuscript": "Manuscrito",
      "wizard.content.inner.packageIndex": "Tabla de contenido del paquete",
      "wizard.content.inner.chapterContent": "Contenido de capítulos",
      "wizard.content.stepCounter": "Paso {{current}} de {{total}} — {{step}}",
      "wizard.content.milestone.index": "Tabla de contenido",
      ...
      "wizard.content.chapters.panelSubtitle":
        "Seleccioná Ebook, bonus o bump; luego editá y aprobá capítulos en el orden de la tabla de contenido global confirmada.",
      ...
      "wizard.content.chapters.generate": "Generar capítulo con IA",
      ...
      "wizard.content.chapters.generateAll": "Generar todos con IA",
      "wizard.content.chapters.regenerateAll": "Re-generar todos con IA",
      "wizard.content.chapters.generateAllLoading": "Generando todos…",
      "wizard.content.chapters.stopGenerateAll": "Detener generación",
      "wizard.content.chapters.generatingOverlayTitle": "Generando capítulos con IA…",
      "wizard.content.chapters.generatingOverlayAria": "Generando capítulos",
      "wizard.content.chapters.generatingOverlayMsgs": [
        "Redactando el contenido uno a uno…",
        "Cada capítulo se escribe con la voz y el contexto del proyecto.",
        "Esto puede tardar unos minutos según la cantidad de capítulos.",
        "La IA está construyendo tu contenido con cuidado.",
      ],
      "wizard.content.chapters.regenerateAllConfirmTitle": "¿Re-generar todos los capítulos?",
      "wizard.content.chapters.regenerateAllConfirmBody": "Esto va a reemplazar el contenido existente de todos los capítulos de este producto.",
      "wizard.content.chapters.regenerateAllConfirmCta": "Sí, re-generar todo",
      "wizard.content.chapters.regenerateAllConfirmCancel": "Cancelar",
      "wizard.content.chapters.toolbarHint":
        "Generar consume créditos solo si la IA responde con éxito. Aprobar marca el capítulo como listo.",
      ...
      "wizard.content.chapters.generateSuccess": "Capítulo generado. Revisalo y ajustalo si querés.",
      ...
      "wizard.content.uploadGate.body":
        "Tu proyecto usa carga de manuscrito. Completá la subida, el parseo y la alineación en el flujo de carga (wizard-upload) antes de editar la tabla de contenido aquí.",
      ...
      "wizard.content.uploadHandoff.hint":
        "Hasta que exista la alineación con propuesta de capítulos (#60), podés continuar con el texto extraído en un solo capítulo del ebook principal y congelar la tabla de contenido del paquete para pasar a la edición por capítulos (sin paso duplicado de tabla de contenido del ebook principal).",
      ...
      "wizard.content.uploadHandoff.success":
        "Listo: el texto quedó precargado en el primer capítulo y la tabla de contenido global quedó confirmada.",
      ...
      "wizard.content.index.packageTocConfirmedAria": "Tabla de contenido confirmada",
      ...
      "wizard.content.index.emptyTocPrompt":
        "Todavía no hay capítulos en la tabla de contenido. Elegí cómo querés empezar.",
      "wizard.content.index.emptyTocGenerate": "Generar tabla de contenido",
      ...
      "wizard.content.index.panelTitleMain": "Tabla de contenido — {{title}}",
      ...
      "wizard.content.index.panelSubtitleMainFrozen":
        "La tabla de contenido está confirmada. Los capítulos siguen en solo lectura hasta que exista el editor de cuerpo (#55).",
      ...
      "wizard.content.index.panelSubtitleBumpChapters":
        "Generá o editá la tabla de contenido como en el ebook principal: Regenerar esquema propone capítulos con IA y consume créditos; podés reordenar con el asa, añadir o quitar filas. Cuando confirmés la tabla de contenido, los títulos quedan fijos hasta el editor de cuerpo.",
      "wizard.content.index.panelSubtitleBumpChaptersFrozen":
        "Tabla de contenido confirmada para este order bump. Los capítulos siguen en solo lectura hasta que exista el editor de cuerpo (#55).",
      "wizard.content.index.mainTitleFallback": "tu ebook",
      "wizard.content.index.regenerateOutline": "Generar tabla de contenido",
      "wizard.content.index.regenerateLoading": "Generando…",
      "wizard.content.index.regenerateOutlineHint":
        "Genera un esquema de capítulos con IA; podés editarlo a mano.",
      "wizard.content.index.singleArtifactTocHint":
        "Los bonuses suelen ser un solo bloque; la tabla de contenido por capítulos aplica al ebook principal y a los order bumps.",
      ...
      "wizard.content.index.confirmIndex": "Confirmar tabla de contenido",
      "wizard.content.index.confirmLoading": "Guardando…",
      "wizard.content.index.confirmIndexHint":
        "Al confirmar se congela globalmente la tabla de contenido de Ebook, bonus y bumps, y avanzás al paso de edición por capítulos.",
      "wizard.content.index.regenerateSuccess": "Esquema actualizado.",
      "wizard.content.index.confirmSuccess": "Tabla de contenido confirmada. Podés continuar cuando el paso de capítulos esté listo.",
      "wizard.content.index.reopenIndex": "Editar tabla de contenido",
      "wizard.content.index.reopenIndexLoading": "Abriendo tabla de contenido…",
      "wizard.content.index.reopenIndexHint": "",
      "wizard.content.index.reopenIndexSuccess": "Tabla de contenido desbloqueada. Editala y volvé a confirmar cuando esté listo.",
      "wizard.content.index.errorReopenIndex": "No pudimos desbloquear la tabla de contenido. Recargá la página o probá de nuevo.",
      ...
      "wizard.content.index.errorConfirmPhase": "No pudimos confirmar la tabla de contenido (fase incorrecta o ya confirmada). Recargá la página.",
      ...
      "wizard.structure.avatarProblem.contentTone.helper":
        "Define cómo escribe la IA los textos del paquete (tabla de contenido, capítulos, bonuses y bumps), no el diseño visual.",
      ...
      "settings.billing.cancelModal.accessUntil": "Acceso hasta el {{date}}",
      "settings.billing.cancelModal.accessUntilDescription": "Podés seguir usando Obra hasta esa fecha sin restricciones.",
      "settings.billing.cancelModal.back": "Volver",
      "settings.billing.cancelModal.confirm": "Cancelar suscripción",
      "settings.billing.cancelSuccess": "Suscripción cancelada. Seguís teniendo acceso hasta {{date}}.",
      "settings.billing.cancelSuccessNoDate": "Suscripción cancelada correctamente.",
      "settings.billing.cancelError": "No se pudo cancelar. Podés gestionarlo en Mercado Pago.",
      ...
      "settings.credits.topUpModal.title": "Comprá créditos",
      "settings.credits.topUpModal.balance": "Saldo actual: {{count}} créditos",
      "settings.credits.topUpModal.confirm": "Confirmar",
      "settings.credits.topUpModal.cancel": "Cancelar",
      "settings.credits.topUpModal.arsPrice": "$ {{amount}} ARS",
  ...
  "pt-BR": {
    translation: {
      ...
      "mobile.title": "Obra foi feita para telas grandes.",
      "mobile.body": "Abra no seu computador para criar seu próximo infoproduto.",
      ...
      "projects.duplicate.menuLabel": "Duplicar",
      "projects.duplicate.title": "Duplicar projeto?",
      "projects.duplicate.body": "Uma cópia completa do projeto será criada. O duplicado começará na etapa de Conteúdo.",
      "projects.duplicate.confirm": "Duplicar",
      "projects.duplicate.cancel": "Cancelar",
      "projects.duplicate.loading": "Duplicando…",
      "projects.duplicate.error": "Não foi possível duplicar o projeto.",
      "projects.duplicate.limitError": "Você já tem 20 projetos ativos. Arquive ou exclua um antes de duplicar.",
      ...
      "wizard.preview.tabs.bump": "Order bump {{n}}",
      "wizard.preview.export.pdf": "Exportar PDF",
      "wizard.preview.export.generatePdf": "Gerar PDF",
      "wizard.preview.export.regeneratePdf": "Re-gerar PDF",
      "wizard.preview.export.download": "Baixar PDF",
      ...
      "wizard.preview.exportPdf.title": "Exportar PDF",
      "wizard.preview.exportPdf.closeLabel": "Fechar exportação de PDF",
      "wizard.preview.exportPdf.generating": "Gerando seu PDF…",
      "wizard.preview.exportPdf.timeRemaining": "Aproximadamente {{seconds}}s restantes",
      "wizard.preview.exportPdf.almostDone": "Quase pronto…",
      "wizard.preview.exportPdf.ready": "PDF pronto!",
      "wizard.preview.exportPdf.readySubtitle": "Seu PDF está pronto para baixar",
      "wizard.preview.exportPdf.failed": "Falha ao gerar",
      "wizard.preview.exportPdf.downloadCta": "Baixar",
      "wizard.preview.exportPdf.tryAgainCta": "Tentar novamente",
      "wizard.preview.exportPdf.closeCta": "Fechar",
      "wizard.preview.exportPdf.noUrlError": "O PDF foi gerado mas o link de download não está disponível. Exporte novamente.",
      "wizard.preview.exportPdf.genericError": "Erro ao gerar o PDF.",
      "wizard.preview.publishStatus.published": "Exportado",
      ...
      "wizard.preview.shell.generating": "Gerando prévia",
      "wizard.preview.shell.generatingTitle": "Criando o design do seu ebook…",
      "wizard.preview.shell.generatingHint": "A IA está montando o design editorial completo. Pode levar alguns minutos.",
      "wizard.preview.shell.loadingMsgs": [
        "Aplicando sua paleta de cores e tipografia…",
        "Isso pode demorar um pouco. Aproveita para tomar um café.",
        "Gerando as páginas uma por uma…",
        "A IA está trabalhando no seu design editorial…",
        "Já está quase pronto, aguenta mais um segundo…",
      ...
      "wizard.preview.shell.regenerateCta": "Regenerar layout",
      ...
      "wizard.preview.generateModal.styleTitle": "Estilo visual",
      "wizard.preview.generateModal.style.illustration": "Ilustrações",
      "wizard.preview.generateModal.style.photography": "Fotografia",
      "wizard.preview.generateModal.style.isometric": "Isométrico",
      "wizard.preview.generateModal.style.minimalist": "Minimalista",
      "wizard.preview.generateModal.style.watercolor": "Aquarela",
      ...
      "wizard.create.source.ai.badge": "Recomendado",
      "wizard.create.source.ai.cardDescription":
        "A IA redige a tabela de conteúdo e todo o conteúdo do seu ebook com base no tema, avatar e estrutura.",
      "wizard.create.source.ai.bullet1": "Tabela de conteúdo gerada e editável antes de escrever",
      ...
      "wizard.create.source.ai.description":
        "A fase de Conteúdo gera tabela de conteúdo e capítulos usando IA.",
      ...
      "wizard.create.source.upload.bullet2": "Análise automática de estrutura e tabela de conteúdo",
      ...
      "wizard.structure.design.bookTemplate.classic_fixed.description":
        "Capa, tabela de conteúdo, abertura de capítulo e corpo com um layout estável e previsível.",
      ...
      "wizard.structure.avatarReset.modal.step2Body":
        "Isso reinicia os marcos de conteúdo do projeto (tabelas de conteúdo, capítulos e progresso), mantém Estrutura concluída e leva você de volta ao passo 2 de Conteúdo com os novos parâmetros.",
      "wizard.structure.avatarReset.modal.cancel": "Cancelar",
      ...
      "wizard.content.planReview.title": "Revise seu plano",
      "wizard.content.planReview.subtitle": "Revise e edite as tabelas de conteúdo de cada produto antes de confirmar.",
      "wizard.content.planReview.confirm": "Confirmar tabelas de conteúdo",
      "wizard.content.planReview.chapterCount_one": "{{count}} capítulo",
      "wizard.content.planReview.chapterCount_other": "{{count}} capítulos",
      "wizard.content.planReview.chapterCount": "{{count}} capítulos",
      "wizard.content.generating.approveArtifact": "Aprovar e continuar",
      "wizard.content.generating.approveArtifactLoading": "Aprovando…",
      "wizard.content.generating.artifactApproved": "Produto aprovado!",
      "wizard.content.generating.generateAll": "Gerar todos com IA",
      "wizard.content.generating.stopGenerate": "Parar geração",
      "wizard.content.generating.allDone": "Pacote completo! Você já pode ir para a Prévia.",
      "wizard.content.generating.backWarningTitle": "Quer voltar a editar o plano?",
      "wizard.content.generating.backWarningBody": "Você pode editar os capítulos, mas a tabela de conteúdo será reaberta e precisará confirmar o plano novamente.",
      "wizard.content.generating.backWarningConfirm": "Sim, reabrir tabela de conteúdo",
      "wizard.content.generating.backWarningCancel": "Continuar editando",
      ...
      "wizard.content.inner.toc": "Tabela de conteúdo",
      "wizard.content.inner.manuscript": "Manuscrito",
      "wizard.content.inner.packageIndex": "Tabela de conteúdo do pacote",
      "wizard.content.inner.chapterContent": "Conteúdo dos capítulos",
      "wizard.content.stepCounter": "Passo {{current}} de {{total}} — {{step}}",
      "wizard.content.milestone.index": "Tabela de conteúdo",
      "wizard.content.milestone.chapters": "Capítulos — corpo do ebook",
      "wizard.content.chapters.panelTitle": "Capítulos — {{title}}",
      "wizard.content.chapters.panelSubtitle":
        "Selecione Ebook, bônus ou bump; depois edite e aprove capítulos na ordem da tabela de conteúdo global confirmada.",
      ...
      "wizard.content.chapters.generate": "Gerar capítulo com IA",
      ...
      "wizard.content.chapters.generateAll": "Gerar todos com IA",
      "wizard.content.chapters.regenerateAll": "Re-gerar todos com IA",
      "wizard.content.chapters.generateAllLoading": "Gerando todos…",
      "wizard.content.chapters.stopGenerateAll": "Parar geração",
      "wizard.content.chapters.generatingOverlayTitle": "Gerando capítulos com IA…",
      "wizard.content.chapters.generatingOverlayAria": "Gerando capítulos",
      "wizard.content.chapters.generatingOverlayMsgs": [
        "Redigindo o conteúdo um a um…",
        "Cada capítulo é escrito com a voz e o contexto do projeto.",
        "Isso pode levar alguns minutos conforme a quantidade de capítulos.",
        "A IA está construindo seu conteúdo com cuidado.",
      ],
      "wizard.content.chapters.regenerateAllConfirmTitle": "Re-gerar todos os capítulos?",
      "wizard.content.chapters.regenerateAllConfirmBody": "Isso vai substituir o conteúdo existente de todos os capítulos deste produto.",
      "wizard.content.chapters.regenerateAllConfirmCta": "Sim, re-gerar tudo",
      "wizard.content.chapters.regenerateAllConfirmCancel": "Cancelar",
      "wizard.content.chapters.toolbarHint":
        "Gerar consome créditos somente se a IA responder com sucesso. Aprovar marca o capítulo como pronto.",
      "wizard.content.chapters.errorInsufficientCredits":
      ...
      "wizard.content.chapters.generateSuccess": "Capítulo gerado. Revise e ajuste se quiser.",
      ...
      "wizard.content.uploadGate.body":
        "Seu projeto usa upload de manuscrito. Conclua o envio, o parse e o alinhamento no fluxo de upload (wizard-upload) antes de editar a tabela de conteúdo aqui.",
      "wizard.content.manuscript.intro":
      ...
      "wizard.content.uploadHandoff.hint":
        "Enquanto o alinhamento com proposta de capítulos (#60) não estiver pronto, você pode continuar com o texto extraído em um único capítulo do ebook principal e congelar a tabela de conteúdo do pacote para ir à edição por capítulos (sem repetir o passo de tabela de conteúdo do ebook principal).",
      ...
      "wizard.content.uploadHandoff.defaultChapterTitle": "Manuscrito importado",
      "wizard.content.uploadHandoff.success":
        "Pronto: o texto foi pré-carregado no primeiro capítulo e a tabela de conteúdo global foi confirmada.",
      ...
      "wizard.content.nav.bumpFallback": "Bump {{n}}",
      "wizard.content.index.packageTocConfirmedAria": "Tabela de conteúdo confirmada",
      "wizard.content.index.packageNavAria": "Conteúdo do pacote",
      "wizard.content.packSidebar.heading": "Seu pacote",
      "wizard.content.index.emptyTocPrompt":
        "Ainda não há capítulos na tabela de conteúdo. Escolha como quer começar.",
      "wizard.content.index.emptyTocGenerate": "Gerar tabela de conteúdo",
      ...
      "wizard.content.index.panelTitleMain": "Tabela de conteúdo — {{title}}",
      "wizard.content.index.panelSubtitleMain":
      ...
      "wizard.content.index.panelSubtitleMainFrozen":
        "A tabela de conteúdo está confirmada. Os capítulos ficam somente leitura até existir o editor de corpo (#55).",
      ...
      "wizard.content.index.panelSubtitleBumpChapters":
        "Gere ou edite a tabela de conteúdo como no ebook principal: Regenerar esquema sugere capítulos com IA e consome créditos; você pode reordenar pelo ícone, adicionar ou remover linhas. Ao confirmar a tabela de conteúdo, os títulos ficam fixos até o editor de corpo.",
      "wizard.content.index.panelSubtitleBumpChaptersFrozen":
        "Tabela de conteúdo confirmada para este order bump. Os capítulos ficam somente leitura até existir o editor de corpo (#55).",
      "wizard.content.index.mainTitleFallback": "seu ebook",
      "wizard.content.index.regenerateOutline": "Gerar tabela de conteúdo",
      "wizard.content.index.regenerateLoading": "Gerando…",
      "wizard.content.index.regenerateOutlineHint":
        "Gera um esquema de capítulos com IA; você pode editar manualmente.",
      "wizard.content.index.singleArtifactTocHint":
        "Os bônus costumam ser um único bloco; a tabela de conteúdo por capítulos vale para o ebook principal e para os order bumps.",
      "wizard.content.index.chapterTitleLabel": "Capítulo {{index}}",
      ...
      "wizard.content.index.sampleChapterTitle": "Capítulo {{n}}",
      "wizard.content.index.singleSectionTitle": "{{title}}",
      "wizard.content.index.confirmIndex": "Confirmar tabela de conteúdo",
      "wizard.content.index.confirmLoading": "Salvando…",
      "wizard.content.index.confirmIndexHint":
        "Ao confirmar, a tabela de conteúdo de Ebook, bônus e bumps é congelada globalmente e você avança para a edição por capítulos.",
      "wizard.content.index.regenerateSuccess": "Esquema atualizado.",
      "wizard.content.index.confirmSuccess": "Tabela de conteúdo confirmada. Você poderá continuar quando a etapa de capítulos estiver pronta.",
      "wizard.content.index.reopenIndex": "Editar tabela de conteúdo",
      "wizard.content.index.reopenIndexLoading": "Abrindo tabela de conteúdo…",
      "wizard.content.index.reopenIndexHint":
        "Volte a editar títulos e ordem da tabela de conteúdo. Se renomear um capítulo com conteúdo, perguntaremos se deseja limpar o corpo.",
      "wizard.content.index.reopenIndexSuccess": "Tabela de conteúdo desbloqueada. Edite e confirme novamente quando estiver pronto.",
      "wizard.content.index.errorReopenIndex": "Não foi possível desbloquear a tabela de conteúdo. Recarregue a página ou tente de novo.",
      "wizard.content.index.errorInsufficientCredits":
      ...
      "wizard.content.index.errorSaveToc": "Não foi possível salvar a tabela de conteúdo.",
      "wizard.content.index.errorConfirmPhase": "Não foi possível confirmar a tabela de conteúdo (fase incorreta ou já confirmada). Recarregue a página.",
      ...
      "wizard.structure.avatarProblem.contentTone.helper":
        "Define como a IA escreve os textos do pacote (tabela de conteúdo, capítulos, bônus e bumps), não o visual.",
