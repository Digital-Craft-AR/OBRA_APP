    ...
    <div className="flex min-h-screen bg-obra-blue-50">
      ...
      <main className="flex flex-1 flex-col gap-8 p-10">
        <header className="space-y-2">
          <h1 className="font-display text-2xl font-bold text-obra-blue-950">{t("help.title")}</h1>
          <p className="max-w-3xl text-sm text-obra-neutral-600">{t("help.intro")}</p>
        </header>

        <section aria-labelledby="help-faq-heading" className="max-w-3xl rounded-card border border-obra-blue-100 bg-white p-6 shadow-card">
        ...
        <section
          ...
          className="max-w-3xl rounded-card border border-obra-blue-100 bg-white p-6 shadow-card"
        >
